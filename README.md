...
| 기능       | 설명                                                   | 이미지                                                                                          |
|------------|--------------------------------------------------------|-------------------------------------------------------------------------------------------------|
| **드래그앤 드롭을 통한 근무 직책 설정 변경** | 사장님은 직원의 직책을 수정하고, 새로운 직책을 추가할 수 있어요. <br/><br/>**드래그앤 드롭으로** 편하게 원하는 직원의 직책을 수정 가능해요. | <img alt="직책 수정 및 생성 페이지 이미지" src="https://github.com/user-attachments/assets/97e8c6a7-0b3e-4c48-8ac6-ea500b948f2d"> |
| **신규 직원 합류 푸시 알림** | 사장님은 신규 직원이 추가되어었을때 푸시 알림을 날릴 수 있어요.

| **정적인 컨텐츠 조회** | 사장님은 마이페이지에서 가게 정보, 개인정보 처리방침, 사업자 정보, 앱 버전 등 정적인 컨텐츠를 조회할 수 있어요.   | <img width="270" alt="스크린샷 2024-11-25 오후 10 17 59" src="https://github.com/user-attachments/assets/e6f2acc3-0c64-49a2-a37b-2c856cfc06d7"> |
